...
best_MLP_parameters = {'n_hidden':1, 'n_neurons':38, 'activation':"tanh", 'learning_rate': 0.005, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':0, 'n_neurons':0, 'learning_rate': 0.031}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':3, 'n_neurons':66, 'learning_rate': 0.440}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':22, 'n_lstm_hidden':1, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':1, 'learning_rate': 0.009}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':4, 'kernel_size':5, 'strides': 3, 'n_neurons': 83, 'n_gru_hidden':2, 'neurons_dense': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 0.383}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2), 'repeat':1, 'learning_rate': 0.007}
