...
best_MLP_parameters = {'n_hidden':0, 'n_neurons':0, 'activation':"relu", 'learning_rate': 0.135, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':2, 'n_neurons':39, 'learning_rate': 0.034}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':1, 'n_neurons':82, 'learning_rate': 0.123}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':59, 'n_lstm_hidden':5, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':0, 'learning_rate': 0.342}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':16, 'kernel_size':2, 'strides': 2, 'n_neurons': 86, 'n_gru_hidden':1, 'neurons_dense': 1, 'dropout_rate': 0.2, 'n_dense_hidden': 3, 'learning_rate': 0.022}
...
# Set the parameters for the network
best_TCN_parameters = {'kernel_size':5, 'dilations':[1,2], 'n_tcn_hidden':3, 'neurons': 4, 'dropout_rate': 0.1, 'n_dense_hidden': 1, 'learning_rate': 1.6e-4}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2), 'repeat':1, 'learning_rate': 0.150}
