...
best_MLP_parameters = {'n_hidden':0, 'n_neurons':0, 'activation':"relu", 'learning_rate': 0.041, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':1, 'n_neurons':95, 'learning_rate': 0.022}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':1, 'n_neurons':90, 'learning_rate': 0.433}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':32, 'n_lstm_hidden':2, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':3, 'learning_rate': 0.067}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':4, 'kernel_size':1, 'strides': 4, 'n_neurons': 39, 'n_gru_hidden':2, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden': 3, 'learning_rate': 0.057}
...
# Set the parameters for the network
best_TCN_parameters = {'kernel_size':4, 'dilations':[1,2], 'n_tcn_hidden':3, 'neurons': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 0.031}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2,4,16,32), 'repeat':2, 'learning_rate': 0.002}
