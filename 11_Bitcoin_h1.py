...
best_MLP_parameters = {'n_hidden':0, 'n_neurons':0, 'activation':"relu", 'learning_rate': 0.084, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':3, 'n_neurons':76, 'learning_rate': 0.024}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':4, 'n_neurons':72, 'learning_rate': 0.149}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':44, 'n_lstm_hidden':1, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':4, 'learning_rate': 0.003}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':16, 'kernel_size':2, 'strides': 4, 'n_neurons': 81, 'n_gru_hidden':3, 'neurons_dense': 1, 'dropout_rate': 0.4, 'n_dense_hidden': 2, 'learning_rate': 0.192}
...
# Set the parameters for the network
best_TCN_parameters = {'kernel_size':5, 'dilations':[1,2,4], 'n_tcn_hidden':5, 'neurons': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 6.9e-4}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2), 'repeat':2, 'learning_rate': 0.044}
