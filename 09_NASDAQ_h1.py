...
best_MLP_parameters = {'n_hidden':0, 'n_neurons':0, 'activation':"relu", 'learning_rate': 0.258, 'input_shape': X_train_DL.shape[1]}
...
for train, test in expanding_window.split(X_DL):
    ...
    checkpoint_cb = ModelCheckpoint(f'RandomSearchResults/{Serie}_{Model_Name}_part{part}.h5', save_best_only=True)
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':0, 'n_neurons':0, 'learning_rate': 0.344}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':2, 'n_neurons':63, 'learning_rate': 0.417}
...
# Define the function to create models for the optimization method
def build_model(n_neurons=30, n_lstm_hidden = 1, neurons_dense = 1, dropout_rate = 0.1, n_dense_hidden = 2, learning_rate=0.407):
    model = Sequential()
    if n_lstm_hidden == 1:
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':77, 'n_lstm_hidden':4, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':2, 'learning_rate': 0.006}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':16, 'kernel_size':4, 'strides': 2, 'n_neurons': 90, 'n_gru_hidden':4, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden': 4, 'learning_rate': 0.104}
...
# Set the parameters for the network
best_TCN_parameters = {'kernel_size':4, 'dilations':[1,2], 'n_tcn_hidden':5, 'neurons': 96, 'dropout_rate': 0.2, 'n_dense_hidden': 4, 'learning_rate': 0.047}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2), 'repeat':1, 'learning_rate': 0.017}
