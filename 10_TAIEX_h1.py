...
best_MLP_parameters = {'n_hidden':0, 'n_neurons':0, 'activation':"relu", 'learning_rate': 0.155, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':2, 'n_neurons':36, 'learning_rate': 0.020}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':4, 'n_neurons':96, 'learning_rate': 0.387}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':6, 'n_lstm_hidden':4, 'neurons_dense': 1, 'dropout_rate': 0.2, 'n_dense_hidden':1, 'learning_rate': 0.316}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':64, 'kernel_size':3, 'strides': 5, 'n_neurons': 58, 'n_gru_hidden':1, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden': 3, 'learning_rate': 0.029}
...
# Set the parameters for the network
best_TCN_parameters = {'kernel_size':1, 'dilations':[1,2,4], 'n_tcn_hidden':1, 'neurons': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 0.022}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2,4,8), 'repeat':1, 'learning_rate': 0.005}
