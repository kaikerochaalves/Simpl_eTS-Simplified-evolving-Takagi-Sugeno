...
best_MLP_parameters = {'n_hidden':0, 'n_neurons':0, 'activation':"relu", 'learning_rate': 0.224, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':0, 'n_neurons':0, 'learning_rate': 0.240}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':5, 'n_neurons':21, 'learning_rate': 0.011}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':80, 'n_lstm_hidden':5, 'neurons_dense': 1, 'dropout_rate': 0.1, 'n_dense_hidden':3, 'learning_rate': 0.001}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':32, 'kernel_size':5, 'strides': 4, 'n_neurons': 68, 'n_gru_hidden':3, 'neurons_dense': 1, 'dropout_rate': 0.2, 'n_dense_hidden': 1, 'learning_rate': 0.001}
...
# Set the parameters for the network
best_TCN_parameters = {'kernel_size':4, 'dilations':[1,2], 'n_tcn_hidden':5, 'neurons': 96, 'dropout_rate': 0.2, 'n_dense_hidden': 4, 'learning_rate': 1.6e-4}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2), 'repeat':1, 'learning_rate': 0.040}
