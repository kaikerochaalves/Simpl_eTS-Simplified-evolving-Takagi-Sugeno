...
best_MLP_parameters = {'n_hidden':1, 'n_neurons':39, 'activation':"relu", 'learning_rate': 3.153e-5, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':2, 'n_neurons':96, 'learning_rate': 0.124}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':5, 'n_neurons':96, 'learning_rate': 0.335}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':58, 'n_lstm_hidden':4, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':3, 'learning_rate': 0.005}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':8, 'kernel_size':2, 'strides': 5, 'n_neurons': 42, 'n_gru_hidden':1, 'neurons_dense': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 0.010}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2,4,8), 'repeat':1, 'learning_rate': 0.025}
