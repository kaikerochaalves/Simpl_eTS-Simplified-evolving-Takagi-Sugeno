...
X = Data[Data.columns[1:16]].values
...
def build_model(n_hidden=0, n_neurons=0, activation = "relu", learning_rate=0.040, input_shape=[4]):
    model = Sequential()
...
best_MLP_parameters = {'n_hidden':0, 'n_neurons':0, 'activation':"relu", 'learning_rate': 0.001, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':3, 'n_neurons':91, 'learning_rate': 0.031}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':4, 'n_neurons':64, 'learning_rate': 0.001}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':35, 'n_lstm_hidden':1, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':2, 'learning_rate': 0.006}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':16, 'kernel_size':5, 'strides': 3, 'n_neurons': 46, 'n_gru_hidden':1, 'neurons_dense': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 0.022}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2), 'repeat':1, 'learning_rate': 0.044}
