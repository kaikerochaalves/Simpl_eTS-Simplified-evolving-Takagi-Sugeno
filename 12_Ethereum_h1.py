...
best_MLP_parameters = {'n_hidden':0, 'n_neurons':0, 'activation':"relu", 'learning_rate': 0.137, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':0, 'n_neurons':0, 'learning_rate': 0.366}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':1, 'n_neurons':87, 'learning_rate': 0.002}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':74, 'n_lstm_hidden':5, 'neurons_dense': 1, 'dropout_rate': 0.2, 'n_dense_hidden':4, 'learning_rate': 0.002}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':4, 'kernel_size':3, 'strides': 2, 'n_neurons': 90, 'n_gru_hidden':3, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden': 3, 'learning_rate': 8.4e-4}
...
# Set the parameters for the network
best_TCN_parameters = {'kernel_size':3, 'dilations':[1,2,4,8,16], 'n_tcn_hidden':5, 'neurons': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 0.001}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2,4), 'repeat':1, 'learning_rate': 0.006}
