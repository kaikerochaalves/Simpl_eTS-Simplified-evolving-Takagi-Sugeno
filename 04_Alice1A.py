...
best_MLP_parameters = {'n_hidden':2, 'n_neurons':70, 'activation':"gelu", 'learning_rate': 0.007, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':0, 'n_neurons':0, 'learning_rate': 6.8e-4}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':1, 'n_neurons':3, 'learning_rate': 0.02}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':45, 'n_lstm_hidden':1, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':0, 'learning_rate': 0.01}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':64, 'kernel_size':1, 'strides': 5, 'n_neurons': 56, 'n_gru_hidden':5, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden': 2, 'learning_rate': 9.1e-4}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2,4), 'repeat':1, 'learning_rate': 2.6e-4}
