...
model = Simpl_eTS(InitialOmega = InitialOmega, r = r)
# Train the model
...
plt.plot(OutputTestDenormalized1, color='blue', label='Simpl_eTS')
plt.ylabel('Output')
plt.xlabel('Samples')
plt.legend()
plt.show()
...
plt.plot(OutputTestDenormalized2, color='blue', label='Simpl_eTS')
plt.ylabel('Output')
plt.xlabel('Samples')
plt.legend()
plt.show()
