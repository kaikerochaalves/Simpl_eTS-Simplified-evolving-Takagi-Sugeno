...
best_MLP_parameters = {'n_hidden':0, 'n_neurons':0, 'activation':"relu", 'learning_rate': 0.107, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':3, 'n_neurons':70, 'learning_rate': 0.001}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':5, 'n_neurons':92, 'learning_rate': 2.8e-3}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':53, 'n_lstm_hidden':3, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':2, 'learning_rate': 5.5e-4}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':32, 'kernel_size':5, 'strides': 5, 'n_neurons': 45, 'n_gru_hidden':3, 'neurons_dense': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 0.002}
...
# Set the parameters for the network
best_TCN_parameters = {'kernel_size':5, 'dilations':[1,2,4], 'n_tcn_hidden':1, 'neurons': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 0.008}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2), 'repeat':1, 'learning_rate': 0.047}
