...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':0, 'n_neurons':0, 'learning_rate': 0.033}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':1, 'n_neurons':6, 'learning_rate': 0.080}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':58, 'n_lstm_hidden':1, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':3, 'learning_rate': 0.030}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':64, 'kernel_size':1, 'strides': 5, 'n_neurons': 72, 'n_gru_hidden':4, 'neurons_dense': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 6.8e-4}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2,4,8,16), 'repeat':1, 'learning_rate': 2.6e-4}
