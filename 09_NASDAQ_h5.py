...
best_MLP_parameters = {'n_hidden':0, 'n_neurons':0, 'activation':"relu", 'learning_rate': 0.032, 'input_shape': X_train_DL.shape[1]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':2, 'n_neurons':73, 'learning_rate': 0.008}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':1, 'n_neurons':70, 'learning_rate': 0.351}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':58, 'n_lstm_hidden':1, 'neurons_dense': 1, 'dropout_rate': 0, 'n_dense_hidden':1, 'learning_rate': 0.151}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':64, 'kernel_size':1, 'strides': 3, 'n_neurons': 22, 'n_gru_hidden':5, 'neurons_dense': 1, 'dropout_rate': 0.1, 'n_dense_hidden': 3, 'learning_rate': 0.015}
...
# Set the parameters for the network
best_TCN_parameters = {'kernel_size':5, 'dilations':[1,2,4], 'n_tcn_hidden':2, 'neurons': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 0.007}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2,4,8,16), 'repeat':1, 'learning_rate': 0.010}
